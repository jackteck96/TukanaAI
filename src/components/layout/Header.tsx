...
const Header = () => {
  ...
  return (
    <header className="bg-background/95 backdrop-blur-sm border-b border-border sticky top-0 z-50 after:absolute after:inset-x-0 after:-bottom-px after:h-0.5 after:bg-gradient-rainbow after:opacity-80">
